    ...
    public void playGame(Scanner input2) {
        ...
        while (d.running) {
            try {
                ...
                while (true) {
                    if (d.array.size() == 0) {  //checks if the array is empty and if so has user input a new pet
                        Scanner input = new Scanner(System.in);
                    ...
                    d.array.get(0).printAttributes(); //displays all the pet information + formatting
                    ...
                    if (answer == 1) { // compares user input to selectable options
                        ...
                        System.out.println("Select the number of which pet you want to play with?");
                        ...
                        input2.close();
                        Runtime.getRuntime().exit(0); //closes the program
                    } else if (answer == 7) {
                        if (d.array.size() == 0) {
                            System.out.println("There is no one to adopt!");
                        ...
                        if (d.array.size() == 1 && d.array.get(0).name.equals(petDelete)) {
